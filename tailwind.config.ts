...
export default {
  ...
  theme: {
    ...
    boxShadow: {
      none: 'none',
      input: '0px 2px 4px rgba(0, 0, 0, 0.04)',
      hover: '0px 2px 4px rgba(0, 0, 0, 0.04), 0px 4px 8px rgba(0, 0, 0, 0.04)',
      overlay:
        '0px 2px 4px rgba(0, 0, 0, 0.08), 0px 12px 24px rgba(0, 0, 0, 0.08)',
    },
    extend: {
      maxHeight: {
        dialog: '94vh',
